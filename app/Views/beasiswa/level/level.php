      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
              <a href="<?= base_url('beasiswa/level/input') ?>" class="btn btn-success mb-3 text-white"onclick="return confirm('Apakah Anda yakin ingin menambah data user?')">Tambah Data Level</a>
              <a href="<?= base_url('beasiswa/level/deleted') ?>" class="btn btn-warning mb-3 text-black">Deleted Level</a>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group btn-group-action mt-2" id="action-<?= $value->id_level ?>" style="display: none;"> 
                          <a href="<?= base_url('beasiswa/level/soft/' . $value->id_level) ?>" class="btn btn-danger btn-delete"><i class="bi bi-trash"></i></a><pre></pre> <!-- hapus -->
                          <a href="<?= base_url('beasiswa/level/edit/' . $value->id_level) ?>" class="btn btn-warning"><i class="bi bi-pencil" style="color: white;"></i></a> <!-- edit -->
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
