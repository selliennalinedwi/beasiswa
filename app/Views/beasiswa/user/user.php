      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <pre></pre>
              <a href="<?= base_url('beasiswa/user/input') ?>" class="btn btn-success mb-3 text-white"onclick="return confirm('Apakah Anda yakin ingin menambah data user?')">Tambah Data User</a>
              <a href="<?= base_url('beasiswa/user/deleted') ?>" class="btn btn-warning mb-3 text-black">Deleted User</a>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group btn-group-action mt-2" id="action-<?= $value->id_user ?>" style="display: none;"> 
                          <a href="<?= base_url('beasiswa/user/soft/' . $value->id_user) ?>" class="btn btn-danger btn-delete"><i class="bi bi-trash"></i></a><pre></pre> <!-- hapus -->
                          <a href="<?= base_url('beasiswa/user/edit/' . $value->id_user) ?>" class="btn btn-warning"><i class="bi bi-pencil" style="color: white;"></i></a> <!-- edit --><pre></pre>
                        </div>
                        <a href="<?= base_url('beasiswa/user/reset_password/' . $value->id_user) ?>" class="btn btn-warning btn-sm" onclick="return confirm('Yakin mau reset password user ini ke username-nya?')">
                      Reset Password</a>
                      </td>
                    </tr>
                  <?php } ?>
